...
class SphereTest {
    ...
    void getNormal() {
        ...
        //assertEquals(new Vector(0,3/Math.sqrt(36),5/Math.sqrt(36)),sphere1.getNormal(p1), " ");
        //positive coordinate of sphere and negative coordinate point
        assertEquals(new Vector(-2/Math.sqrt(69),-4/Math.sqrt(69),-7/Math.sqrt(69)),
                sphere1.getNormal(p2),
        ...
        assertEquals(new Vector(2/Math.sqrt(174),7/Math.sqrt(174),11/Math.sqrt(174)),
                sphere2.getNormal(p1),
        ...
        assertEquals(new Vector(2/Math.sqrt(20),0/Math.sqrt(20),-4/Math.sqrt(20)),
                sphere3.getNormal(p3),
